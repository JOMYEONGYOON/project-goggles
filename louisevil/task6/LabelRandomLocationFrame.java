...
class RandomThread extends Thread implements RandomIntegerGeneratable{
	...
	public void run() {
		while(true) { 
			int x = getRandomInt(0, contentPane.getWidth());
			int y = getRandomInt(0, contentPane.getHeight());
...
public class LabelRandomLocationFrame extends JFrame {
	private RandomThread th; // 스레드 레퍼런스
	
	public LabelRandomLocationFrame() {
